...
(1, 'Admin', '11999999999', '$2y$10$KxJ8SkGbJ6H5vJkFv5vJdO8aPqVkHk3Zu0v3.KfU5eR8h5u6f5Eoe', 'admin', 1);
...
INSERT IGNORE INTO categorias (id, nome, descricao, icone, ordem) VALUES
...
-- Tamanhos de Pizza
INSERT IGNORE INTO tamanhos_pizza (id, nome, descricao, fatias, pessoas, ordem) VALUES
...
-- Bairros
INSERT IGNORE INTO bairros (nome, cidade, uf, taxa_entrega, tempo_estimado) VALUES
...
INSERT IGNORE INTO bebidas_categorias (id, nome, icone, cor, ordem) VALUES
...
-- Bebidas
INSERT IGNORE INTO bebidas (nome, categoria_id, volume, preco, estoque) VALUES
...
-- Adicionais
INSERT IGNORE INTO adicionais (nome, preco, ativo) VALUES
...
-- Promoções
INSERT IGNORE INTO promocoes (nome, descricao, preco, desconto, ativo) VALUES
...
-- Pizzas Tradicionais (46 total)
INSERT IGNORE INTO produtos (categoria_id, nome, descricao, preco_p, preco_m, preco_g, disponivel, destaque) VALUES
(1, 'AMERICANA', 'Presunto, palmito, ervilha, ovo, mussarela', 44.90, 66.00, 83.00, 1, 1),
(1, 'A MODA DA CASA', 'Palmito, ovo, catupiry, cebola, mussarela', 44.90, 66.00, 83.00, 1, 1),
...
(1, 'FRANGO C/ CATUPIRY', 'Frango desfiado com catupiry', 44.90, 64.00, 81.00, 1, 0),
...
(2, 'PEPPE CHEESE', 'Mussarela, pepperoni, cream cheese, bacon', NULL, 70.00, 85.00, 1, 0),
...
(3, 'BRIGADEIRO', 'Chocolate granulado, cereja', 44.90, 62.00, NULL, 1, 0),
